...
public class Time2Test
{
    public static void Main(string[] args)
    {
        ...
        Time2 t7 = new Time2(1, 2, 35); // 01:02:35 - accumulate minutes
        Time2 t8 = new Time2(1, 35, 35); // 01:35:35 - accumulate hours
        Time2 t9 = new Time2(12, 35, 35); // 12:35:35 - accumulate days
        ...
        Console.WriteLine("t7: Time2 object t7 specified");
        Console.WriteLine("   {0}", t7.ToUniversalString()); // 01:02:35
        Console.WriteLine("   {0}", t7.ToString()); // 01:02:35 AM

        Console.WriteLine("t8: Time2 object t8 specified");
        Console.WriteLine("   {0}", t8.ToUniversalString()); // 01:35:35
        Console.WriteLine("   {0}", t8.ToString()); // 01:35:35 AM

        Console.WriteLine("t9: Time2 object t9 specified");
        Console.WriteLine("   {0}", t9.ToUniversalString()); // 12:35:35
        Console.WriteLine("   {0}", t9.ToString()); // 01:35:35 AM
