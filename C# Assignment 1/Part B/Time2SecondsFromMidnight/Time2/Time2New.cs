...
public class Time2New
{
    ...
    public Time2New(int h = 0, int m = 0, int s = 0)
    {
    ...
    // Time2 constructor: another Time2 object supplied as an argument
    public void addtime(Time2New atime)
    {
    ...
    public int Minute2
    {
        ...
        set
        {
            ...
            {
                this.hour2 = value + 1;
                this.minute2 = value - 60;
            }
                //throw new ArgumentOutOfRangeException("Minute2", value, "Minute2 must be 0-59");
        } // end set
    ...
    public int Second2
    {
        ...
        set
        {
            if (value >= 0 && value < 60)
                ...
                //throw new ArgumentOutOfRangeException("Second2", value, "Second2 must be 0-59");
            {
                this.minute2 = value + 1;
                this.second2 = value - 60;
            }
    ...
    public virtual string ToUniversalString()
    {
        return string.Format(
           "New Time2 Class:\n\tTime (in seconds) - {0}" +
           "\n\tTime to add (in seconds) - {1}" +
           "\n\tAfter adding (in seconds) - {2} " +
           "", ((Hour*3600)+(Minute*60)+Second), ((Addhour*3600)+-(Addminute*60)+Addsecond), 
    ...
    {
        return string.Format("{0}:{1:D2}:{2:D2} {3} New Time2 Class",
